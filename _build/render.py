...
.scroll{margin:1.4rem 0;overflow-x:auto;border:1px solid var(--line);
  border-radius:10px;background:var(--panel);box-shadow:var(--shadow)}
table{border-collapse:separate;border-spacing:0;width:100%;
  min-width:max-content;font-size:.9rem;font-family:var(--mono);
  white-space:nowrap}
...
@media(max-width:40rem){
  ...
  .app-head,.app-row{grid-template-columns:1.35fr .62fr .8fr .95fr}
  .app-head span:nth-child(2),.app-row span:nth-child(2),
  .app-head span:nth-child(5),.app-row span:nth-child(5),
  ...
  nav{padding:.6rem 0 .6rem 1.15rem;gap:.85rem;flex-wrap:nowrap;
    align-items:center}
  .brand{flex:none;font-size:1rem}
